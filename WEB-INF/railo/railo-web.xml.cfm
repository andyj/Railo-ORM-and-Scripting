...
-->
    ...
    arguments:
	 ...
	 -->
	<setting show-version="true" suppress-whitespace="false"/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.hsqldb.jdbcDriver" clob="false" connectionTimeout="1" custom="path=%2FormTest%2F" database="ormTest" dsn="jdbc:hsqldb:file:{path}{database}" host="" name="ormTest" username="sa"/>
  </data-sources>
